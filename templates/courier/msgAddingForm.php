...
<body>
    ...
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-3"><strong>AJOUTER MSG </strong></h5>
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    <h6 class="mb-4">INFORMATIONS MSG</h6>
                    <form action="index.php?action=addMSG" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" rows="2" placeholder="entrez la référence du message" style="text-transform: uppercase;" class="form-control" id="reference" name="reference" required />
                            </div>
                        </div>
