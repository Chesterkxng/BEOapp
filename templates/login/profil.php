                ...
                <div class="col-md-6 col-sm-6 col-12 login-box-form p-4">
                    ...
                    <form action="index.php?action=profileCompletion" method='post' class="mt-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control mt-0" placeholder="Surname" autocomplete="off" type="text" id="surname" name="surname" required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" autocomplete="off" id="firstName" name="firstName" placeholder="First Name" class="form-control mt-0" required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" autocomplete="off" type="text" id="function" name="function" placeholder="Function" class="form-control mt-0" required>
                        </div>
