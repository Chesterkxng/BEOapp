    ...
    <div class="row header shadow-sm">
        ...
        <div class="col-sm-3 pl-0 text-center header-logo">
            <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                <h3 class="logo"><a href="#" class="text-secondary logo"><i class="fa fa-book"></i> BEO<span class="small">APP</span></a></h3>
            </div>
        </div>
        <!--Logo-->
        <!--Header Menu-->
                ...
                ?>
                        ...
                        <div class="sidebar-menu-container">
                            <ul class="sidebar-menu mt-4 mb-4">
                                ...
                                <li class="parent">
                                    <a href="index.php?action=stagesList" class=""><i class="fa fa-graduation-cap mr-3"></i>
                                        <span class="none">STAGES </span>
                                    </a>
                                </li>

                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('calender'); return false" class=""><i class="fa fa-calendar mr-3"> </i>
                                        <span class="none">CALENDRIER<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
                                    <ul class="children" id="calender">
                                        <li class="child"><a href="index.php?action=eventsList" class="ml-4"><i class="fa fa-angle-right mr-2"></i> LISTE D'EVENEMENTS</a></li>
                                        <li class="child"><a href="index.php?action=calendar" class="ml-4"><i class="fa fa-angle-right mr-2"></i> CALENDRIER PERSONEL</a></li>
                                        <li class="child"><a href="index.php?action=sharedCalendar" class="ml-4"><i class="fa fa-angle-right mr-2"></i> CALENDRIER PARTAGE</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('todo'); return false" class=""><i class="fa fa-list-ul mr-3"> </i>
                                        <span class="none">A FAIRE<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
                                    <ul class="children" id="todo">
                                        <li class="child"><a href="index.php?action=todoAddingForm" class="ml-4"><i class="fa fa-angle-right mr-2"></i> AJOUTER</a></li>
                                        <li class="child"><a href="index.php?action=todosList" class="ml-4"><i class="fa fa-angle-right mr-2"></i> LISTE</a></li>
                                        <li class="child"><a href="index.php?action=todoHistoric" class="ml-4"><i class="fa fa-angle-right mr-2"></i> HISTORIQUE</a></li>
                                ...
                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('mission_orders'); return false" class=""><i class="fa fa-file-word mr-3"> </i>
                                        <span class="none">ORDRES DE MISSION<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
                                    <ul class="children" id="mission_orders">
                                        <li class="child"><a href="index.php?action=intMOgenerator" class="ml-4"><i class="fa fa-angle-right mr-2"></i> INTERIEUR</a></li>
                                        <li class="child"><a href="index.php?action=MOArchives" class="ml-4"><i class="fa fa-angle-right mr-2"></i> ARCHIVES</a></li>
                                    </ul>
                                </li>

                                <li class="parent">
                                    <a href="#" onclick="toggle_menu('correspondences'); return false" class=""><i class="fa fa-envelope mr-3"> </i>
                                        <span class="none">CORRESPONDANCES<i class="fa fa-angle-down pull-right align-bottom"></i></span>
                                    </a>
                                ...
                                <li class="parent">
                                    <a href="index.php?action=Archives" class=""><i class="fa fa-archive mr-3"> </i>
                                        <span class="none">ARCHIVES</span>
                                    </a>
                                </li>

                                <li class="parent">
                                    <a href="index.php?action=usersList"  class=""><i class="fa fa-key mr-3"> </i>
