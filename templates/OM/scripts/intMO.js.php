<script type="text/javascript"> 
    function  generateOM(){
        ...
        switch(companions){
                case "SEUL":
                    if (companion){
                    window.open('templates/OM/assets/OMint_alone.html'); 
                ...
                case "UN (01) MILITAIRE": 
                    if (companion){
                    window.open('templates/OM/assets/OMint_one.html');
                    document.getElementById('btn_save').innerHTML = 
                    '<label class="control-label col-sm-3" for=""></label>'+
                        '<div class="col-sm-5">'+
                            '<button onclick="document.getElementById(\'Moform\').submit()"  class="btn btn-info btn-lg btn-block"><strong>SAVE</strong></button>'+
                ...
                case "DEUX (02) MILITAIRES": 
                    ...
                    window.open('templates/OM/assets/OMint_two.html');
                    document.getElementById('btn_save').innerHTML = 
                    '<label class="control-label col-sm-3" for=""></label>'+
                        '<div class="col-sm-5">'+
                            '<button onclick="document.getElementById(\'Moform\').submit()"  class="btn btn-info btn-lg btn-block"><strong>SAVE</strong></button>'+
                ...
                case "TROIS (03) MILITAIRES": 
                    ...
                    window.open('templates/OM/assets/OMint_three.html');
                    document.getElementById('btn_save').innerHTML = 
                    '<label class="control-label col-sm-3" for=""></label>'+
                        '<div class="col-sm-5">'+
                            '<button onclick="document.getElementById(\'Moform\').submit()"  class="btn btn-info btn-lg btn-block"><strong>SAVE</strong></button>'+
