            ...
            <div class="col-sm-12">
                <div class="mt-4 mb-3 p-3  button-container bg-white border shadow-sm">
                    ...
                    <form id="Moform" action="index.php?action=saveIntMO" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="PN">PERSONNEL NUMBER</label>
                            <div class="col-sm-5">
                                <input type="text" style="text-transform: uppercase;" autocomplete="off"
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="city">DESTINATION CITY</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="companion">COMPANIONS</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="object">OBJECT OF THE MISSION</label>
                            <div class="col-sm-5">
                                <input type="text" autocomplete="off" style="text-transform: uppercase;"
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="means">TRANSPORT MEANS</label>
                            <div class="col-sm-5">
                                <input type="text" autocomplete="off" style="text-transform: uppercase;"
                        ...
                        <div class="form-group row">
                            <label class="control-label col-sm-3" for="returndate">RETURN DATE</label>
                            <div class="col-sm-5">
                                <input type="text" autocomplete="off" style="text-transform: uppercase;"
