...
class MessageRepository
{
    ...
    public function addMessage(
        ...
        $statement = $this->connection->getConnection()->prepare(
            "INSERT INTO `message`(`TYPE`,`REFERENCE`,`OBJECT`,`EDITION_DATE`, `URL`) 
            VALUES (?,?,?,?,?)"
        );
        $statement->execute([$type, $reference, $object, $edition_date, $url]);
    ...
    public function updateMessage(int $type, string $reference, string $object, string $edition_date, int $message_id): bool
    {
        $statement = $this->connection->getConnection()->prepare(
            "UPDATE `message` 
            SET 
        ...
        $statement->execute([$type, $reference, $object, $edition_date, $message_id]);
