...
class OMRepository
{
    ...
    public function addOM(
        ...
        $statement = $this->connection->getConnection()->prepare(
            "INSERT INTO `om`(`RECIPIENT`, `CITY`, `COMPANIONS`, `OBJECT`, `MEANS`, `DEPARTURE_DATE`, `RETURN_DATE`,`EDITION_DATE`) 
            VALUES (?,?,?,?,?,?,?,?)"
        );
        $edition_date = date('Y-m-d');
        $statement->execute([$recipient, $city, $companions, $object, $means, $departure_date, $return_date, $edition_date]);
