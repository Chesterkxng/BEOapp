...
class BordereauRepository
{
    ...
    public function addBordereau(
        ...
        $statement = $this->connection->getConnection()->prepare(
            "INSERT INTO `bordereau`(`REFERENCE`, `OBJECT`,`EDITION_DATE`, `URL`) 
            VALUES (?,?,?,?)"
        );
    ...
    public function updateBordereau(string $reference, string $object, string $edition_date, int $bordereau_id): bool
    {
        $statement = $this->connection->getConnection()->prepare(
            "UPDATE `bordereau` 
            SET 
        ...
        $statement->execute([$reference,  $object, $edition_date, $bordereau_id]);
